...
namespace Portals.Characters.FirstPerson
{
    ...
    public class FirstPersonController : MonoBehaviour
    {
        ...
        private void OnPortalExit(Portal portal) {
            ...
            m_TeleportRoutine = StartCoroutine(TeleportRoutine(1.0f));
        }
        ...
        private IEnumerator TeleportRoutine(float duration) {
            ...
            while (elapsed < duration) {
                m_MouseLook.LookRotation2(transform, m_Camera.transform, 10.0f, false);

                yield return null;
                elapsed += Time.deltaTime;
            }

            m_MouseLook.LookRotation2(transform, m_Camera.transform, 10.0f, true);
            m_Teleporting = false;
        }
    }
}
